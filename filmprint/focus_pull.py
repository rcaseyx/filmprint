...
# balance itself. 0 means "no pixelation, full resolution". Carried over the
# same 5-stage cadence as the old reveal-percentage schedule.
STAGE_PIXEL_BLOCKS = [3, 6, 10, 18, 0]
